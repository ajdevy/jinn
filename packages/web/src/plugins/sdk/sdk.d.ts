/**
 * The public type contract of `@jinn/plugin-sdk`, version 1.0.0.
 *
 ...
 *  version it predates. */
export declare const SDK_CONTRACT_VERSION: '1.0.0'
...
export interface PluginHost {
  ...
  /** Show a notification, or log it when no surface is mounted. Never throws. */
