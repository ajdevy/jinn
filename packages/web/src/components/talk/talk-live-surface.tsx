...
import type { OrbIntensity, OrbVariant } from "./orb-motion"
 ...
 */
export function TalkLiveSurface({ sessionId = null, variant = "mist", intensity = "standard" }: TalkLiveSurfaceProps) {
