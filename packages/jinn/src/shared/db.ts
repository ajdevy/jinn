...
export function initDb(): Database.Database {
  ...
  const initialize = database.transaction(() => {
    ...
    database.exec(CREATE_CONNECTOR_DELIVERY_RECEIPTS_TABLE);
