...
function assertStockRecord({ home, materializedBundleDir, record, reviewed, preMergeTree }) {
...
export function assertStockBundleApplied({ home, materializedBundleDir, manifest, receipt, preMergeTree }) {
  ...
  for (const record of manifest.files) assertStockRecord({ home, materializedBundleDir, record, reviewed, preMergeTree })
}
